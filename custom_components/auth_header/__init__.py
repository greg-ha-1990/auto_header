...
CONFIG_SCHEMA = vol.Schema(
    {
        DOMAIN: vol.Schema(
            {
                vol.Optional(CONF_USERNAME_HEADER, default="X-Forwarded-Preferred-Username"): cv.string,
                vol.Optional(CONF_TARGET_TOKEN): cv.string,
                vol.Optional(CONF_TARGET_GUEST_USER_ID): cv.string,
                vol.Optional(CONF_ALLOW_BYPASS_LOGIN, default=True): cv.boolean,
